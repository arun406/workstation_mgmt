package com.accelya.product.workstationmanagement.appointment.mapper;
...
public interface AppointmentMapper {
    ...
    List<Appointment> dtoListToEntityList(List<AppointmentDTO> appointments);
    ...
    @Mappings({
            ...
            @Mapping(source = "transportInfo.flightDate", target = "flightDate"),
    ...
    @Mappings({
            ...
            @Mapping(target = "transportInfo.flightDate", source = "flightDate"),
